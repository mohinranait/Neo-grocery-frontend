...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-white  pt-20  lg:pt-[120px] ">
      <div className="container px-2 md:px-0 mx-auto">
          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              <a
                ...
                className="mb-6 text-4xl font-bold inline-block max-w-[160px]"
              >
                Logo
              </a>
        ...
        <div className="py-5 flex items-center justify-between border-t border-slate-200 ">
          <div>
            <p>Copy right reserve 2025</p>
          </div>
