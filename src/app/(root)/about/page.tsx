...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 py-12 sm:py-16 lg:py-20">
            ...
            <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
              <div className="space-y-4">
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight">
                  Farm to Table
                  <span className="text-emerald-600 block">Since 2015</span>
                </h1>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <Quote className="w-12 h-12 sm:w-16 sm:h-16 text-emerald-600 mx-auto mb-6 sm:mb-8" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 sm:px-8 py-3 rounded-full"
              >
                Start Shopping
              ...
              <Button
                size="lg"
                variant="outline"
                className="px-6 sm:px-8 py-3 rounded-full bg-transparent border-emerald-600 text-emerald-600 hover:bg-emerald-50"
              >
                Partner with Us
              </Button>
            </div>
